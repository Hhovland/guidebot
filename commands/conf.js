...
exports.run = async(client, message, [ action, key, ...value ], level) => { // eslint-disable-line no-unused-vars
	...
	if (action === "add") {
		if (!key) {
			return message.reply({ content: "Please specify a key to add", allowedMentions: { repliedUser: (replying === "true") } })
		}
		if (defaults[key]) {
			return message.reply({ content: "This key already exists in the default settings", allowedMentions: { repliedUser: (replying === "true") } })
		}
		if (value.length < 1) {
			return message.reply({ content: "Please specify a value", allowedMentions: { repliedUser: (replying === "true") } })
		}
	...
	if (action === "edit") {
		if (!key) {
			return message.reply({ content: "Please specify a key to edit", allowedMentions: { repliedUser: (replying === "true") } })
		}
		if (!defaults[key]) {
			return message.reply({ content: "This key does not exist in the settings", allowedMentions: { repliedUser: (replying === "true") } })
		}
		if (value.length < 1) {
			return message.reply({ content: "Please specify a new value", allowedMentions: { repliedUser: (replying === "true") } })
		}
	...
	if (action === "del") {
		if (!key) {
			return message.reply({ content: "Please specify a key to delete.", allowedMentions: { repliedUser: (replying === "true") } })
		}
		if (!defaults[key]) {
			return message.reply({ content: "This key does not exist in the settings", allowedMentions: { repliedUser: (replying === "true") } })
		}
	...
	if (action === "get") {
		if (!key) {
			return message.reply({ content: "Please specify a key to view", allowedMentions: { repliedUser: (replying === "true") } })
		}
		if (!defaults[key]) {
			return message.reply({ content: "This key does not exist in the settings", allowedMentions: { repliedUser: (replying === "true") } })
		}
